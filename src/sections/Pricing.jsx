        ...
        <section>
            <Element name="pricing">
                <div className="container">
                    <div className="relative pb-40 mx-auto border-l border-r max-w-960 pricing-head_before border-s2 bg-s1/50 pt-28 max-lg:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                    ...
                    <div className="relative flex items-start -mt-12 scroll-hide z-2 max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
                        {plans.map((plan, index) => (
                            <div key={plan.id} className="pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]">
                                ...
                                <ul className="mx-auto space-y-4 xl:px-7">
                                    {plan.features.map((feature) => (
                                        <li key={feature} className="relative flex items-center gap-5">
                                            <img src={Check} alt="check" className="object-contain size-10" />
                                ...
                                {index === 1 &&
                                    <p className="text-center small-compact mt-9 text-p3 before:mx-2.5 before:content-['-'] after:mx-2.5 after:content-['-']">
                                        Limited time offer
                                    </p>
                                }
                            </div>
